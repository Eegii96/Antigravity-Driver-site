          ...
          <div className="bg-[var(--bg2)] border border-[var(--border)] p-5 rounded-xl space-y-4 shadow-xl relative overflow-hidden text-left font-sans">
            ...
            <div className="text-xs space-y-2.5">
              <div className="flex justify-between items-center text-[var(--muted-foreground)]">
                ...
                <span className="text-xs text-[var(--accent-foreground)] font-mono font-medium max-w-[130px] truncate" title={currentUser?.email || currentUser?.phone}>
                  {currentUser?.email || currentUser?.phone || 'Тодорхойгүй'}
                </span>
              </div>
              <div className="flex justify-between items-center text-[var(--muted-foreground)]">
                <span className="font-medium text-[var(--muted-foreground)]">Төхөөрөмж / OS:</span>
                <span className="text-xs text-[var(--accent-foreground)] font-medium text-right">
              ...
              <div className="flex justify-between items-center text-[var(--muted-foreground)]">
                ...
                <span className="text-xs text-[var(--verify)] font-bold flex items-center space-x-1 bg-[rgba(31,138,76,0.1)] px-2 py-0.5 rounded border border-[var(--verify)] font-mono">
                  <span>SSL (HTTPS)</span>
                </span>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="block w-full px-3 py-1.5 border border-[var(--border)] rounded bg-[var(--bg2)] text-[var(--fg)] text-xs focus:ring-1 focus:ring-[var(--accent)] focus:outline-none"
                  />
                  <p className="mt-1 text-sm text-[var(--muted-foreground)] font-sans">
          ...
          <div className="bg-rose-950/10 border border-rose-900/40 p-6 rounded-xl space-y-3">
            ...
            <div className="pt-2">
              <button
                ...
                className="bg-transparent hover:bg-rose-900/20 text-rose-400 border border-rose-900/60 px-3 py-1.5 rounded text-xs font-medium transition-colors cursor-pointer"
              >
          ...
          >
            ...
            {deleteSuccess ? (
              ...
              <div className="p-5 space-y-4">
                ...
                {deleteError && (
                  <div className="p-2 bg-rose-500/10 border border-rose-500/20 text-rose-300 text-sm rounded flex items-center space-x-1.5 animate-fade-in">
